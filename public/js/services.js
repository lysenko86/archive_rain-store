...
rainApp.service('categoriesServ', function(requestServ){
...
rainApp.service('accountsServ', function($rootScope, requestServ, messagesServ){
...
rainApp.service('budgetsServ', function(requestServ){
...
rainApp.service('propertiesServ', function(requestServ){
...
rainApp.service('analyticsServ', function($http, requestServ){
